        ...
        <appLayout :showtop="showSearch">
                        ...
                        <el-form :model="queryParams" size="small" :inline="true">
                            ...
                            <el-form-item label="资金池">
                                <el-select v-model="queryParams.poolsId" clearable placeholder="资金池">
                                    <el-option v-for="item in pools" :key="item.label" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </el-form-item>
            ...
            <template #dmain="scope">
                ...
                <el-table v-loading="loading" ref="multipleTable" @cell-click="copyToClipboard" :data="tableData"
                    ...
                    <el-table-column prop="eth" label="兑换金额(ETH)" :formatter="formatterColumn" show-overflow-tooltip>
                    </el-table-column>

                    <el-table-column prop="ethPrice" label="汇率" :formatter="formatterColumn" show-overflow-tooltip>
                    </el-table-column>
                    <el-table-column prop="usdc" label="USDC金额" :formatter="formatterColumn" show-overflow-tooltip>
                    </el-table-column>
                </el-table>
                <!-- 分页 -->
                <div class="page">
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            this.$http({
                url: this.$http.adornUrl("/admin/exchange/list"),
                method: "post",
