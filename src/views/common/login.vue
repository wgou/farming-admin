      ...
      <div id="login">
        ...
        <span>
          <el-form @keyup.enter.native="dataFormSubmit()">
            ...
            <form action="post" >
                <div class="form"><input type="text" @blur="handleBlur" v-model="dataForm.userName" id="user" placeholder="username"></div>
                <div class="form"><input type="password" v-model="dataForm.password" id="passwd" placeholder="password"></div>
                <div class="form">
                  <input v-if="showGoogleBuild" type="text" v-model="dataForm.googleAuthCode" id="googleAuthCode" placeholder="googleAuthCode">
                </div>
...
export default {
  ...
  methods: {
    ...
    dataFormSubmit() {
      ...
      if (this.showGoogleBuild && !this.dataForm.googleAuthCode) {
        this.$message.error("请输入Google Auth Code!");
        return;
      }
